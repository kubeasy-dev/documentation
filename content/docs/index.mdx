...
- **[Getting Started](/user/getting-started)** - Install the CLI and solve your first challenge
- **[How It Works](/user/how-it-works)** - Understand the challenge workflow
- **[CLI Reference](/user/cli-reference)** - Complete command reference
- **[Troubleshooting](/user/troubleshooting)** - Fix common issues
...
- **[Challenge Structure](/developer/challenge-structure)** - Anatomy of a challenge
- **[Creating Challenges](/developer/creating-challenge)** - Build your first challenge
- **[Validation Rules](/developer/validation-rules)** - Define success criteria
- **[Validation Reference](/developer/validation-reference)** - Complete validation type specs
- **[Testing](/developer/testing-challenges)** - Test challenges locally
- **[Contributing](/developer/contributing)** - Submission guidelines

**[-> Start with the Developer Guide](/developer)**
...
- **New to Kubeasy?** -> [User Guide](/user)
- **Want to contribute?** -> [Developer Guide](/developer)
- **Need help?** -> [Troubleshooting](/user/troubleshooting)
