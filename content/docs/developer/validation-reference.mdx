...
- [Validation Rules](/developer/validation-rules) -- Practical examples and anti-patterns
- [Challenge Structure](/developer/challenge-structure) -- Complete challenge format
- [Testing Challenges](/developer/testing-challenges) -- Testing validation locally
