...
See [Validation Rules](/developer/validation-rules) for detailed examples and [Validation Reference](/developer/validation-reference) for complete specs.
...
- [Creating Your First Challenge](/developer/creating-challenge) - Step-by-step guide
- [Validation Rules](/developer/validation-rules) - Detailed validation examples
- [Validation Reference](/developer/validation-reference) - Complete type specifications
- [Testing Challenges](/developer/testing-challenges) - How to test locally
