...
See [Challenge Structure - Custom Images](/developer/challenge-structure#5-image-directory-optional) for details.
</Callout>
...
- Read [Validation Rules](/developer/validation-rules) for more validation types
- See [Validation Reference](/developer/validation-reference) for complete type specifications
- See [Challenge Structure](/developer/challenge-structure) for complete reference
